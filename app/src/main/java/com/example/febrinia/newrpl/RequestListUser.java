...
public class RequestListUser extends AppCompatActivity {
    ...
    Context mContext = RequestListUser.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_request_list_user);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mImageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(RequestListUser.this,KeranjangUser.class);
                startActivity(i);
